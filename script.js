const rooms = [
    ...
    { id: '101', building: 'Arts Student Centre', capacity: 8, whiteboard: true, tv: true, outlets: true, url: 'https://aus.ubc.ca/arts-student-centre/room-bookings'},
    { id: '302', building: 'Arts Student Centre', capacity: 8, whiteboard: true, tv: true, outlets: true, url: 'https://aus.ubc.ca/arts-student-centre/room-bookings'},
    { id: '303', building: 'Arts Student Centre', capacity: 4, whiteboard: true, tv: false, outlets: true, url: 'https://aus.ubc.ca/arts-student-centre/room-bookings'},
    { id: '304', building: 'Arts Student Centre', capacity: 4, whiteboard: true, tv: false, outlets: true, url: 'https://aus.ubc.ca/arts-student-centre/room-bookings'},
    { id: '208', building: 'Engineering Student Centre', capacity: 10, whiteboard: true, tv: false, outlets: true, url: 'https://ubcengineers.ca/study-rooms'},
    { id: '209', building: 'Engineering Student Centre', capacity: 10, whiteboard: true, tv: false, outlets: true, url: 'https://ubcengineers.ca/study-rooms'},
    { id: '210', building: 'Engineering Student Centre', capacity: 10, whiteboard: true, tv: false, outlets: true, url: 'https://ubcengineers.ca/study-rooms'},
    { id: '213', building: 'Engineering Student Centre', capacity: 20, whiteboard: true, tv: false, outlets: true, url: 'https://ubcengineers.ca/study-rooms'},
];
